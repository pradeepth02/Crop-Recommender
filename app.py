...
def main():
    ...
    st.warning("Note: This A.I application is for educational/demo purposes only and cannot be relied upon. Check the source code [here](https://github.com/pradeepth02/Crop-Recommender)")
    hide_menu_style = """
    <style>
